package hangeureut.global.security.config;
...
import hangeureut.domain.user.service.UserQueryService;
import hangeureut.global.security.LoginService;
import hangeureut.global.security.jwt.JwtService;
import hangeureut.global.security.jwt.filter.CustomUsernamePwdAuthenticationFilter;
import hangeureut.global.security.jwt.filter.JwtAuthenticationFilter;
import hangeureut.global.security.jwt.handler.JwtLoginFailureHandler;
import hangeureut.global.security.jwt.handler.JwtLoginSuccessHandler;
import hangeureut.global.security.oauth.CustomOAuth2UserService;
import hangeureut.global.security.oauth.handler.OAuth2LoginFailureHandler;
import hangeureut.global.security.oauth.handler.OAuth2LoginSuccessHandler;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests((requests) -> requests
				.requestMatchers("/login", "/api/user/signup", "/", "/favicon.ico")
				.permitAll() // 허용된 주소
				.anyRequest()
				.authenticated()
			)
