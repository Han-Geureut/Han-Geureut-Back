package hangeureut.domain.user.web.controller;
...
import hangeureut.domain.album.service.AlbumPostQueryService;
import hangeureut.domain.user.converter.UserConverter;
import hangeureut.domain.user.entity.User;
import hangeureut.domain.user.service.UserCommandService;
...
import hangeureut.global.annotation.LoginUser;
...
public class UserRestController {
	...
	@PutMapping("/profile")
	public ApiResponse<UserResponseDTO.UpdateUserProfileResponseDTO> updateProfile(@LoginUser User user,
		@Valid @ModelAttribute UserRequestDTO.UpdateProfileRequestDTO request) {
		return ApiResponse.onSuccess(userCommandService.updateProfile(user, request));
	}
